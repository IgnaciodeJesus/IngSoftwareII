...
const Footer = () => {
   ...
   return (
      <footer className="mt-auto color-primary-bg mx-0 container-fluid row d-flex justify-content-between">
         <div className="col-md-4 d-flex flex-column footer-item text-center">
            <a
               href=""
               className="py-2">
         ...
         <div className="col-md-4 my-3 footer-item d-flex justify-content-center align-items-center">
            <a href="#">Contacto</a>
         </div>
         <div className="col-md-4 my-3 footer-item d-flex justify-content-center align-items-center">
            {socials.map((social) => (
